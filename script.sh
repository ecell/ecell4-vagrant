...
cd /vagrant/ecell4/core; CXXFLAGS="-Wall -O2" LD_LIBRARY_PATH=/usr/local/lib python ../waf configure build install
cd /vagrant/ecell4/gillespie; CXXFLAGS="-Wall -O2" LD_LIBRARY_PATH=/usr/local/lib python ../waf configure build install
cd /vagrant/ecell4/ode; CXXFLAGS="-Wall -O2" LD_LIBRARY_PATH=/usr/local/lib python ../waf configure build install
cd /vagrant/ecell4/lattice; CXXFLAGS="-Wall -O2" LD_LIBRARY_PATH=/usr/local/lib python ../waf configure build install
cd /vagrant/ecell4/bd; CXXFLAGS="-Wall -O2" LD_LIBRARY_PATH=/usr/local/lib python ../waf configure build install

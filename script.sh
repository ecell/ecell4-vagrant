...
cd /root; git clone git://github.com/ecell/ecell4; cd /root/ecell4; git checkout viz;
...
cd /root/ecell4; PREFIX=/usr/local bash install.sh core_python gillespie_python ode_python lattice_python bd_python reaction_reader util_python
